...
### A5
Tiled 每输出加载：每个 tile 16KB+16KB=32KB × 2 × N/TILE次 = 32KB × 2 × 32 = 2MB（共享全局加载）。
每输出总全局字节 = N²×4(写C) + 2N²/TILE×TILE²×4 = 4N² + 8N² = 12N² 字节（约 12 MB for N=1024）。
计算量 = 2N³ = 2G FLOP。
算术强度 = 2×1024³ / (12×1024²×4) = 2×1024 / 48 ≈ **42.7 FLOP/Byte**。
